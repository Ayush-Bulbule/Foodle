        ...
        <>
            ...
            >
                <Box mb={3}>
                    ...
                    <Input value={address.building} onChange={handleChange} name='building' mb={3} placeholder='Plot A2' size='md' />
                </Box>
                <Box mb={3}>
                ...
                <Box mb={3}>
                    ...
                    <Input value={address.locality} onChange={handleChange} name='locality' mb={3} placeholder='Near KVP ' size='md' />
                </Box>
                <Box mb={3}>
